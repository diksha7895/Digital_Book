...
public class Book {
	...
	public Book(Long id, String logo, @NotBlank String title, @NotBlank String category, @NotNull Long price,
			Long authorId, @NotBlank String authorName, @NotBlank String publisher, Timestamp publishedDate,
			@NotBlank @Size(min = 50, max = 2000) String content, boolean active) {
		super();
		this.id = id;
		this.logo = logo;
		this.title = title;
